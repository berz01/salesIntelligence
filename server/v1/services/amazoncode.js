...
exports.handler = function(event, context) {
    ...
    var timestamp = new Date(event.metadata.reported.isCrash.timestamp*1000);
    ...
    sns.publish({
        TopicArn: "arn:aws:sns:us-east-1:532406091859:carCrashSNS",
    ...
    dynamodb.putItem({
        ...
        if (err) {
            context.done('error dynoDB','putting item into dynamodb failed: '+err);
        }
        else {
